...
!function (t, o, s, e) {
    ...
    t.extend(r.prototype, {
        init: function () {
            ...
            return this.tipso_bubble || (this.tipso_bubble = t('<div class="tipso_bubble"><div class="tipso_content" style="text-align: ' + this.settings.textAlign +'; word-wrap:break-word"></div><div class="tipso_arrow"></div></div>')), this.tipso_bubble
        }, show: function () {
